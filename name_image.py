...
"""
name_images.py
Module for collecting and naming images from folders generated by 
main.py and automate_main.py.
Accepts 3 arguments: --input_path, --output_path, --base_name
...
def main(input_path: Path, output_path: Path, base_name: str) -> None:
    img_cnt = 1
